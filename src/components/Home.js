...
import { Text, View,ScrollView, Image, TouchableOpacity, StatusBar, TextInput, FlatList}from 'react-native';
    ...
    return(
      <TouchableOpacity activeOpacity={0.9} onPress={()=> setCurrentSelected(index)}>
        <View style={{
          ...
          alignItems:'center',
          backgroundColor:currentSelected == index ? COLORS.accentPink: COLORS.white,
          borderRadius: 20,
          margin: 10,
          elevation: 5,
        }}>
          ...
          <View style={{
            width:30,height:30, 
            borderRadius:100, 
            backgroundColor:currentSelected == index? COLORS.white:   COLORS.accentPink,
        ...
        <View style={{
          ...
          <View style={{
            ...
            <View style={{
              ...
              <Entypo name="plus" style={{fontSize: 18, color: COLORS.white}}/>
            </View>
            <View style={{
              flexDirection:'row',
              alignItems:'center',
              ...
              <AntDesign name='star' style={{fontSize: 12, color: COLORS.black, paddingRight: 5}}/>
              <Text style={{
              fontSize: 15,
              color:COLORS.black,
              fontWeight:'bold',
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={{
          ...
          <View style={{
            ...
            <TouchableOpacity>
              <Material
              name="segment" style={{fontSize:28, color:COLORS.black}}/>
            </TouchableOpacity>
          </View>
          ...
          <View style={{
            ...
            style={{
              color:COLORS.black, fontSize:16, paddingVertical:5, 
              borderBottomWidth:1, borderBottomColor:COLORS.black + 20,
